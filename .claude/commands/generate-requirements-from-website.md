...
> **BẮT BUỘC:** Đọc skill `requirements_analyzer` tại `.claude/skills/requirements_analyzer/SKILL.md` trước khi bắt đầu.
...
2. **Khảo sát hệ thống**
   - Dùng browser tools (Claude Browser MCP) để truy cập module.
