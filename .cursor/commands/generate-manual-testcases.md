---
name: generate-manual-testcases
...
> - `.cursor/skills/requirements_analyzer/SKILL.md`
> - `.cursor/skills/generate_testcases/SKILL.md`
...
- Rà soát `ambiguity_checklist.md` (trong skill)
